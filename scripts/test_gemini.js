...
(async () => {
    ...
    try {
        const res = await chatWithAI({
            system: 'You are a tester. Reply with a short JSON object {"ok": true, "provider":"<provider>"}',
            messages: [{ role: 'user', content: 'Please return ONLY the JSON object: {"ok": true, "provider": "test"}' }],
