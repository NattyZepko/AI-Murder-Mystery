  ...
  return (
    <div style={{ padding: 32, maxWidth: 800, margin: '0 auto', background: 'rgba(30,41,59,0.95)', color: '#e5e7eb', borderRadius: 12, boxShadow: '0 4px 24px #0004' }}>
      ...
      <p style={{ fontSize: 18, lineHeight: 1.7 }}>
        <strong>AI Murder Mystery</strong> is an interactive detective experience powered by advanced AI models. Each game session generates a brand new, unique murder case for you to solve by interrogating suspects, collecting clues, and making your final accusation.
      </p>
      <h3 style={{ marginTop: 28, fontSize: 22 }}>Game Flow</h3>
      ...
      <div style={{ display: 'flex', justifyContent: 'center', margin: '24px 0' }}>
        <svg width="540" height="120" viewBox="0 0 540 120" style={{ background: 'none' }}>
          <g fontFamily="system-ui,sans-serif" fontSize="15">
            ...
            <text x="65" y="65" textAnchor="middle" fill="#e5e7eb">Start Game</text>
            <rect x="140" y="40" width="120" height="40" rx="10" fill="#334155" stroke="#64748b" strokeWidth="2" />
            <text x="200" y="65" textAnchor="middle" fill="#e5e7eb">Generate Scenario</text>
            <rect x="280" y="40" width="110" height="40" rx="10" fill="#334155" stroke="#64748b" strokeWidth="2" />
            <text x="335" y="65" textAnchor="middle" fill="#e5e7eb">Interrogate</text>
            <rect x="410" y="40" width="110" height="40" rx="10" fill="#334155" stroke="#64748b" strokeWidth="2" />
            <text x="465" y="65" textAnchor="middle" fill="#e5e7eb">Accuse</text>
      ...
      <h3 style={{ marginTop: 28, fontSize: 22 }}>System Architecture</h3>
      ...
      <div style={{ display: 'flex', justifyContent: 'center', margin: '24px 0' }}>
        <svg width="600" height="160" viewBox="0 0 600 160" style={{ background: 'none' }}>
          <g fontFamily="system-ui,sans-serif" fontSize="15">
            ...
            <text x="110" y="85" textAnchor="middle" fill="#e5e7eb" fontSize="17">React Client</text>
            ...
            <text x="300" y="75" textAnchor="middle" fill="#e5e7eb" fontSize="17">Express API</text>
            <text x="300" y="95" textAnchor="middle" fill="#e5e7eb" fontSize="13">Scenario, Chat, Clues</text>
            {/* Arrow to AI Model */}
            ...
            <text x="500" y="85" textAnchor="middle" fill="#e5e7eb" fontSize="17">AI Backend</text>
      ...
      <h3 style={{ marginTop: 28, fontSize: 22 }}>AI Backend</h3>
      ...
      <p style={{ fontSize: 16, marginTop: 8 }}>
        The AI backend powers all scenario generation, suspect dialogue, and clue extraction for your game session.
      </p>
      <h3 style={{ marginTop: 28, fontSize: 22 }}>Behind the Scenes</h3>
      <ul style={{ fontSize: 17, lineHeight: 1.7, marginLeft: 24 }}>
      ...
      <h3 style={{ marginTop: 28, fontSize: 22 }}>Technical Stack</h3>
      <ul style={{ fontSize: 17, lineHeight: 1.7, marginLeft: 24 }}>
      ...
      <h3 style={{ marginTop: 28, fontSize: 22 }}>Extending & Customizing</h3>
      <ul style={{ fontSize: 17, lineHeight: 1.7, marginLeft: 24 }}>
